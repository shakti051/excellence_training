...
class UpcomingAppointExpert extends StatefulWidget {
  ...
  UpcomingAppointExpert(
      ...
      this.generalFound = false})
      : super(key: key);

  @override
  _UpcomingAppointExpertState createState() => _UpcomingAppointExpertState();
}

class _UpcomingAppointExpertState extends State<UpcomingAppointExpert> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget
                                .appointmentExpertModel!
                                .appointmentexpertDetails![widget.firstGeneral]
