...
class CashInvoice extends StatefulWidget {
  final String invoiceID;
  final String packageName;
  final CashInvoiceDetail invoiceDetail;
  const CashInvoice(
      {Key? key,
  ...
  @override
  State<CashInvoice> createState() => _CashInvoiceDetail();
}

class _CashInvoiceDetail extends State<CashInvoice> {
  String savePath = '';
  String taskId = '';
  var progress = 0;
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          HeadingTitleText(
                            ...
                            fontWeight: FontWeight.w600,
                            title:
                                'Rs ${widget.invoiceDetail.invoiceTotalAmountAfterDiscount}',
                          ),
                        ],
                      ),
                      subtitle: Row(
                        ...
                        children: [
                          ...
                          HeadingTitleText(
                            ...
                            fontWeight: FontWeight.w600,
                            title:
                                '(-) Rs.${widget.invoiceDetail.invoiceTotalDiscount}',
                          ),
                        ],
                      ),
                    ),
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          HeadingTitleText(
                            ...
                            fontWeight: FontWeight.w600,
                            title:
                                'Rs ${widget.invoiceDetail.invoiceTotalPaidIncTaxAmount}',
                          ),
                        ],
                      ),
                    ),
  ...
  ListTile totalListPrice({required InvoicePModeDtl invoicePaymentModeDetail}) {
    return ListTile(
      ...
      subtitle: HeadingTitleText(
        fontSize: FontSize.small,
        fontWeight: FontWeight.normal,
        title: invoicePaymentModeDetail.invoicePackagePaymentDate,
        color: AppColors.grey,
      ),
      trailing: HeadingTitleText(
        fontSize: FontSize.defaultFont,
        fontWeight: FontWeight.w600,
        title: 'Rs ${invoicePaymentModeDetail.invoicePackagePaymentAmount}',
        color: AppColors.grey,
      ),
    );
  }
