...
import 'package:vlcc/screens/consultation/consultation_form.dart';

class ConsultationClinics extends StatelessWidget {
  const ConsultationClinics({Key? key}) : super(key: key);
