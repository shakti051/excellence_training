...
class ReminderPopUpDetails extends StatefulWidget {
  VlccReminderModel? data;
  ReminderPopUpDetails({Key? key, this.data}) : super(key: key);

  @override
  _ReminderPopUpDetailsState createState() => _ReminderPopUpDetailsState();
}

class _ReminderPopUpDetailsState extends State<ReminderPopUpDetails> {
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                      "Appointment ID:${widget.data!.id.toString()} ",
                                      style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                ...
                                Container(
                                  margin: EdgeInsets.symmetric(
                                      vertical: MarginSize.small),
                                  child: Text(
                                    widget.data!.reminderDescription,
                                    style: TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: FontSize.normal),
                                  ),
                              ...
                              children: [
                                Container(
                                    ...
                                    child: SvgPicture.asset(
                                        "assets/images/category.svg")),
                                Flexible(
                                  child: Text(widget.data!.addressLine2,
                                      style: TextStyle(
                                          fontFamily: FontName.frutinger,
                                          fontWeight: FontWeight.w600,
                                          fontSize: FontSize.large)),
