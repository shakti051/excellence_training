...
class AchievmentScreen extends StatefulWidget {
  ...
  bool me;
  AchievmentScreen(this.achievementData,this.me);

  @override
  _AchievmentScreenState createState() => _AchievmentScreenState();
}
...
class _AchievmentScreenState extends State<AchievmentScreen> {
  ...
  Future<void> createAchievmentCall() async {
    // 9812010471
  ...
  // Future<void> updateAchievmentCall() async {
  //   // 9812010471
  //
  //   var jsonstring = {
  //     "userId":uniqueId,
      ...
      body: Container(
        child: Column(
          children: <Widget>[
            ...
            // ),
            Expanded(
              child: widget.achievementData != null
                  ? Container(
                      ...
                      child: GridView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: widget.achievementData.length,
                              ...
                              onTap: (){
                                showDialog(
                                    ...
                                    builder: (_) => MyDialog(
                                        "Achievement",
                                        widget.me,
                                        widget.achievementData[index].images,
                                        widget.achievementData[index].title,
                                        widget.achievementData[index].link,
                                        widget
                                            .achievementData[index].description));
                              },
                              child: Container(
                                child: Stack(
                                  children: [
