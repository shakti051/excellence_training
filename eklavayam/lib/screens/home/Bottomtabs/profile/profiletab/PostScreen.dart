...
import 'package:eklavayam/screens/home/Bottomtabs/model/MyPostModel.dart';
...
class PostScreen extends StatefulWidget {
  ...
  PostScreen(this.userid,this.loggeduserid);
...
class _PostScreenState extends State<PostScreen> with TickerProviderStateMixin {
  ...
  Future<void> getStoryList() async {
    ...
    var jsonstring = {"uniqueId": widget.userid, "pageNumber": 0};
    var jsondata = jsonEncode(jsonstring);
    print(jsondata);
    NetworkClient networkClient = new NetworkClient();
    var responsedata = await networkClient.postData(getMyPostUrl, jsondata);

    print(responsedata);
    Navigator.pop(context);
    if (responsedata['status'] == 1) {
      MyPostModel storyfeedModel = new MyPostModel.fromJson(responsedata);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //             ),
            //             child: Image.asset("assets/images/penlogo.png"),
            //           ),
            //         ),
            //         Expanded(
            //           child: Card(
            ...
            Container(
              ...
              width: MediaQuery.of(context).size.width,
              color: orangecolor,
              child: Text("My Feed",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),),
            ),
            SizedBox(height: 5,),
            storylist != null
                ? Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    comments[index].user.name.length < 25
                                        ? Text(
