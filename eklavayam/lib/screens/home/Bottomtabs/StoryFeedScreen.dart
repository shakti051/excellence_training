...
import 'package:eklavayam/screens/home/Bottomtabs/profile/LikeDialog.dart';
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          GestureDetector(
                                            onTap: (){
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfileHomeScreen(int.parse(storylist[index].id), uniqueId)));
                                            },
                                            child: Row(
                                              children: <Widget>[
                                                SizedBox(
                                            ...
                                            children: <Widget>[
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  commentBottomSheet(
                                                      context,
                                                      storylist[index].contentUniqueId,
                                                      storylist[index]
                                                          .comments);
                                                },
                                                child: Row(
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  if(reply.length>0)
                                                    {
                                                      commentApi(comments[index].commentId,reply,"2");
                                                    }
                                                },
                                                child: CircleAvatar(
                                                  backgroundColor: orangecolor,
